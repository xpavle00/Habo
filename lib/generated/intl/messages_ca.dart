...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(theme) =>
      "${Intl.select(theme, {'device': 'Dispositiu', 'light': 'Clar', 'dark': 'Fosc', 'oled': 'Negre pur (OLED)', 'other': 'Dispositiu'})}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "habitContract": MessageLookupByLibrary.simpleMessage("Contracte d\'hàbit"),
    ...
    "habitLoop": MessageLookupByLibrary.simpleMessage("El bucle de l\'hàbit"),
    ...
    "showReward": MessageLookupByLibrary.simpleMessage("Mostra la recompensa"),
