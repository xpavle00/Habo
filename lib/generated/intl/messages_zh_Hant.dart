...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "allHabitsWillBeReplaced":
            MessageLookupByLibrary.simpleMessage("所有習慣都將會被備份中的習慣取代。"),
        ...
        "appNotificationsChannel":
            MessageLookupByLibrary.simpleMessage("應用程式通知的通知管道"),
        ...
        "defineYourHabitsDescription":
            MessageLookupByLibrary.simpleMessage("為了更好地維持習慣，你可以定義："),
        ...
        "doNotForgetToCheckYourHabits":
            MessageLookupByLibrary.simpleMessage("別忘了檢視你的習慣。"),
        ...
        "fifteenMinOfVideoGames":
            MessageLookupByLibrary.simpleMessage("玩 15 分鐘電玩遊戲"),
        ...
        "habitNotificationsChannel":
            MessageLookupByLibrary.simpleMessage("習慣通知的通知管道"),
        ...
        "haboNeedsPermission":
            MessageLookupByLibrary.simpleMessage("Habo 需要權限才能傳送通知並正常運作。"),
        "ifYouWantToSupport":
        ...
        "remainderOfSanction":
            MessageLookupByLibrary.simpleMessage("未成功執行慣例後的懲罰提醒。"),
        ...
        "rewardDescription":
            MessageLookupByLibrary.simpleMessage("是你在執行慣例後獲得的好處或正面感受，這能強化習慣。"),
        "rewardNumbered": MessageLookupByLibrary.simpleMessage("3. 獎勵"),
        "routine": MessageLookupByLibrary.simpleMessage("慣例"),
        "routineDescription":
            MessageLookupByLibrary.simpleMessage("是你回應提示所採取的行動。這就是習慣本身。"),
        ...
        "skipDoesNotAffectStreaks":
            MessageLookupByLibrary.simpleMessage("跳過（不影響連續紀錄）"),
