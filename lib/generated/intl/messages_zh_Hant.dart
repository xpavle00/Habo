...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m0(theme) =>
      "${Intl.select(theme, {'device': '裝置', 'light': '淺色', 'dark': '深色', 'oled': 'OLED 黑色', 'other': '裝置'})}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "congratulationsReward": MessageLookupByLibrary.simpleMessage("恭喜！你的獎勵："),
    ...
    "createYourFirstHabit": MessageLookupByLibrary.simpleMessage("建立你的第一個習慣。"),
    ...
    "habitTitleEmptyError": MessageLookupByLibrary.simpleMessage("習慣的標題不以可空白。"),
    ...
    "remainderOfReward": MessageLookupByLibrary.simpleMessage("成功執行慣例後的獎勵提醒。"),
    ...
    "restoreFailedError": MessageLookupByLibrary.simpleMessage("錯誤：還原備份失敗。"),
