...
void main() {
  group('NotificationService', () {
    ...
    test('disableHabitNotification should delegate to global function', () {
      // This test verifies the method exists and can be called
      expect(
        () => notificationService.disableHabitNotification(1),
        returnsNormally,
      );
    });
    ...
    test('handleHabitEventAdded should handle habit completion today', () {
      ...
      // This test verifies the method exists and can be called
      expect(
        () => notificationService.handleHabitEventAdded(1, today, event),
        returnsNormally,
      );
    });
    ...
    test('handleHabitEventDeleted should handle event deletion today', () {
      ...
      // This test verifies the method exists and can be called
      expect(
        () => notificationService.handleHabitEventDeleted(1, today),
        returnsNormally,
      );
    });
    ...
    test(
      ...
      () {
        ...
        // This test verifies the method exists and can be called
        expect(
          () => notificationService.handleHabitEventDeleted(1, yesterday),
          returnsNormally,
        );
      },
    );
    ...
    group('with sample habits', () {
      ...
      test(
        'resetNotifications should handle habits with notifications enabled',
        () {
          expect(
            () => notificationService.resetNotifications(sampleHabits),
            returnsNormally,
          );
        },
      );
      ...
      test('removeNotifications should handle multiple habits', () {
        expect(
          () => notificationService.removeNotifications(sampleHabits),
          returnsNormally,
        );
      });
    });
